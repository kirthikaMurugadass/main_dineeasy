  ...
  landing: {
    ...
    features: {
      ...
      qr: {
        ...
        description: "Guests scan a table QR to instantly open your digital menu—no app required.",
      },
      multilang: {
        title: "Instant food ordering",
        description: "Let guests order directly from their phone with a fast, modern cart and checkout.",
      },
      themes: {
        title: "Table booking via QR",
        description: "Allow guests to reserve tables or join a waitlist from the same QR flow.",
      },
      publish: {
        title: "Smart menu categories",
        description: "Organize dishes into intuitive categories so guests find what they want fast.",
      },
      mobile: {
        title: "Real-time order management",
        description: "Track new, in-progress, and ready orders in a single real-time view for your team.",
      },
      analytics: {
        title: "Mobile-first digital menu",
        description: "A beautiful menu designed for phones—no pinching, zooming, or PDF downloads required.",
      },
    },
    demo: {
      label: "Live Preview",
...
const de: Dictionary = {
  ...
  landing: {
    ...
    features: {
      ...
      qr: {
        title: "QR-Menüzugang",
        description: "Gäste scannen den Tisch-QR und öffnen sofort Ihr digitales Menü—ohne App.",
      },
      multilang: {
        title: "Sofort bestellen",
        description: "Gäste bestellen direkt am Smartphone – mit modernem Warenkorb & Checkout.",
      },
      themes: {
        title: "Tischbuchung per QR",
        description: "Reservierungen oder Warteliste direkt über den gleichen QR-Flow.",
      },
      publish: {
        title: "Smarte Kategorien",
        description: "Gerichte in Kategorien ordnen, damit Gäste schneller finden, was sie möchten.",
      },
      mobile: {
        title: "Echtzeit-Bestellungen",
        description: "Neue, laufende und fertige Bestellungen in einer Echtzeit-Ansicht verfolgen.",
      },
      analytics: {
        title: "Mobile-first Menü",
        description: "Ein Menü für Smartphones—kein Zoomen, kein PDF, keine Downloads nötig.",
      },
    },
    demo: {
      label: "Live-Vorschau",
...
const fr: Dictionary = {
  ...
  landing: {
    ...
    features: {
      ...
      qr: { title: "Accès au menu via QR", description: "Les clients scannent le QR de la table pour ouvrir instantanément le menu—sans app." },
      multilang: { title: "Commande instantanée", description: "Permettez aux clients de commander depuis leur téléphone avec un panier et un checkout modernes." },
      themes: { title: "Réservation via QR", description: "Réservez une table ou rejoignez une liste d’attente depuis le même QR." },
      publish: { title: "Catégories intelligentes", description: "Organisez les plats en catégories pour une navigation rapide et claire." },
      mobile: { title: "Gestion des commandes en temps réel", description: "Suivez les commandes (nouvelles, en cours, prêtes) en une seule vue temps réel." },
      analytics: { title: "Menu digital mobile-first", description: "Un menu pensé pour le mobile—pas de zoom, pas de PDF, aucun téléchargement." },
    },
...
const it: Dictionary = {
  ...
  landing: {
    ...
    features: {
      ...
      qr: { title: "Accesso menu via QR", description: "I clienti scansionano il QR del tavolo e aprono subito il menu—senza app." },
      multilang: { title: "Ordina subito", description: "Permetti agli ospiti di ordinare dal telefono con carrello e checkout moderni." },
      themes: { title: "Prenotazione tavolo via QR", description: "Prenota un tavolo o entra in lista d’attesa dallo stesso QR." },
      publish: { title: "Categorie smart", description: "Organizza i piatti in categorie per una navigazione veloce e chiara." },
      mobile: { title: "Gestione ordini in tempo reale", description: "Monitora ordini nuovi, in preparazione e pronti in un’unica vista realtime." },
      analytics: { title: "Menu digitale mobile-first", description: "Un menu progettato per smartphone—niente zoom, niente PDF, nessun download." },
    },
