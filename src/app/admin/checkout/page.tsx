...
export default function AdminCheckoutPage() {
  ...
  const [status, setStatus] = useState<"loading" | "ready" | "already_pro">("loading");
  ...
  const defaultBilling = billingParam === "annual" ? "annual" : "monthly";
  ...
  if (status === "already_pro") {
    return (
      <div className="flex min-h-[40vh] flex-col items-center justify-center gap-4">
        <p className="text-muted-foreground">You already have Pro. Redirecting to dashboard...</p>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold">Complete your Pro subscription</h1>
