...
export function CTASection() {
  ...
  return (
    <section className="relative overflow-hidden py-32">
      {/* Dark background */}
      <div className="absolute inset-0 -z-10 bg-espresso dark:bg-card" />
      ...
      />
      <motion.div
        className="absolute -right-32 -bottom-32 h-96 w-96 rounded-full bg-olive/10 blur-3xl"
        animate={{ x: [0, -20, 0], y: [0, 20, 0] }}
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <FadeIn>
          <h2 className="font-serif text-4xl font-bold tracking-tight text-warm sm:text-5xl lg:text-6xl">
            {t.landing.cta.title}
          </h2>
        </FadeIn>
