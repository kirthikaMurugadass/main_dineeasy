      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <FadeIn delay={0.3} className="mt-16 flex justify-center">
          <div className="relative w-full max-w-sm">
            {/* Phone frame */}
            <div className="rounded-[2.8rem] border-[10px] border-foreground/10 bg-card shadow-premium overflow-hidden">
              {/* Header image */}
              <div className="relative h-40 overflow-hidden">
                ...
                <div className="absolute bottom-3 left-4 right-4">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-full bg-espresso flex items-center justify-center text-warm text-xs font-bold font-serif">
                      C
                    </div>
                    <div>
