...
import { QrCode, Smartphone, Table2 } from "lucide-react";
...
export function SpotlightSection() {
  ...
  const parallaxY = useTransform(scrollYProgress, [0, 1], prefersReduced ? [0, 0] : [10, -10]);
  ...
  function DeviceFrame({
    ...
    return (
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-[28px] bg-white/45 ring-1 ring-black/5 backdrop-blur-xl shadow-floating dark:bg-card/30 dark:ring-white/10">
          {/* light sweep */}
      ...
      <div className="relative mx-auto w-full max-w-[280px] sm:max-w-[300px]" style={{ aspectRatio: "9 / 19.5" }}>
        ...
        <div className="absolute inset-[14px] overflow-hidden rounded-[40px] bg-[var(--background)] ring-1 ring-white/20 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.10)]">
          ...
          <div className="relative px-4 pb-4 pt-10">
            {variant === "scan" && (
              <div className="relative rounded-3xl bg-[var(--hero-bg)] p-4 ring-1 ring-border/60 shadow-card">
  ...
  return (
    <section
      ref={ref}
      className={cn(
        "relative overflow-hidden border-t border-border/60 py-24 md:py-28 lg:py-32",
        "fade-up",
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <FadeIn delay={0.08}>
            <h2 className="mt-4 text-balance text-[clamp(2.25rem,3.6vw+0.6rem,3.4rem)] font-bold leading-tight tracking-tight text-foreground">
                  ...
                  <div className={cn("grid items-center gap-10 lg:grid-cols-2 lg:gap-12", isReverse && "lg:[&>*:first-child]:order-2")}>
                    ...
                    >
                      <div className={cn("relative", !prefersReduced && "animate-phone-float")}>
                        <DeviceFrame>
                          <PhonePreview variant={item.variant} />
                        </DeviceFrame>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary ring-1 ring-primary/20">
                        {item.icon}
                        <span className="uppercase tracking-[0.22em]">Spotlight</span>
                      </div>
